...
import { Wifi, Lightbulb, Lock } from 'lucide-react';

const Footer = () => {
  return (
    <footer className="bg-ehome-text text-white">
      <div className="section-container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              <span className="text-2xl font-bold text-gradient bg-gradient-to-r from-purple-light to-white bg-clip-text text-transparent">
                Easy Home
              </span>
              <span className="ml-1 text-xs text-gray-400">
                by <a href="https://tartilab.ru" target="_blank" rel="noopener noreferrer" className="hover:text-purple-light hover:underline">TartiLab</a>
              </span>
            </div>
